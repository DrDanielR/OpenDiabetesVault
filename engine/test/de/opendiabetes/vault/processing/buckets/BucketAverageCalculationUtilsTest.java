...
public class BucketAverageCalculationUtilsTest {
    ...
    public void testSmallestSize() throws ParseException {
        ...
        Pair<VaultEntryType, Pair<Double, Double>> informationPair_1 = new Pair(VaultEntryType.BOLUS_SQUARE, new Pair(1, 100.0));
        Pair<VaultEntryType, Pair<Double, Double>> informationPair_2 = new Pair(VaultEntryType.BOLUS_SQUARE, new Pair(1, 100.0));
        // first double == timer
        // second double == value
    ...
    public void testWantedSize() throws ParseException {
        ...
        Pair<VaultEntryType, Pair<Double, Double>> informationPair_7 = new Pair(VaultEntryType.BOLUS_SQUARE, new Pair(1, 100.0));
        Pair<VaultEntryType, Pair<Double, Double>> informationPair_8 = new Pair(VaultEntryType.BOLUS_SQUARE, new Pair(1, 100.0));
        // first double == timer
        // second double == value
        ...
        Pair<VaultEntryType, Pair<Double, Double>> informationPair_11 = new Pair(VaultEntryType.BOLUS_SQUARE, new Pair(1, 100.0));
        Pair<VaultEntryType, Pair<Double, Double>> informationPair_12 = new Pair(VaultEntryType.BOLUS_SQUARE, new Pair(1, 100.0));
        // first double == timer
        // second double == value
